 ...
 * 订单数据表
    ...
    · 付款方式，1 表示在线支付
    · 运费
    · 订单状态，0 表示已取消， 10 表示未付款，20 表示已付款， 30 表示已发货， 40 表示交易成功， 50 表示交易关闭
    · 支付时间
    · 发货时间
    · 交易完成时间
